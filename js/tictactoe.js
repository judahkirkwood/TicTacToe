...
let activePlayer = 'X';
//This array stores an array of moves. We use thisto determine win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("images/tile1.jpg")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage = 'url("images/tile2.jpg")';
        }
    ...
    function checkWinConditions() {
        ...
        //9 squares are selected the code executes.
            ...
            //This function plays the ti game sound.
            audio('./media/tie.mp3');
    ...
    function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
        ...
        function animateLineDrawing() {
            ...
            c.stroke();
            //This method checks if we've reached the enpoints.
            if (x1 <= x2 && y1 <= y2) {
            ...
            //This condition is similar to the one above.
            //This is nevessary for the  6, 4, 2 win condition.
            if (x1 <= x2 && y1 >= y2) {
                if (x < x2) { x += 10; }
                if (y > y2) { y -= 10; }
    ...
    function resetGame() {
        ...
        for (let i = 0; i < 9; i++) {
            ...
            //This remobes our elements backgroundImage.
